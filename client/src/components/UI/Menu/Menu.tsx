...
const Menu: FC<MenuProps> = ({menuIndex}) => {
    ...
    const menuWindows = [<Inventory setNotificationItem={setNotificationItem} setNotificationMintNFTIsVisible={setNotificationMintNFTIsVisible}/>, <div>NFT</div>, <Quests/>]
    const dispatch = useAppDispatch()
    const title = () => {
        switch (menuIndex) {
            case 0:return 'Инвентарь';
            case 1:return 'NFT'
            case 2:return 'Квесты'
